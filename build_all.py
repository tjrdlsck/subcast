...
def main():
    print("=== Subcast Enterprise Build & Packaging Pipeline v1.3.2 ===")
    ...
    zip_filename = os.path.join("dist", "subcast-v1.3.2-windows.zip")
    ...
    print(f" - Installer: dist/Subcast_Setup_v1.3.2.exe")
    print(f" - Auto-Update ZIP: dist/subcast-v1.3.2-windows.zip")
