...
def main():
    print("=== Subcast Enterprise Build & Packaging Pipeline v1.3.8 ===")
    ...
    zip_filename = os.path.join("dist", "subcast-v1.3.8-windows.zip")
    ...
    print(f" - Installer: dist/Subcast_Setup_v1.3.8.exe")
    print(f" - Auto-Update ZIP: dist/subcast-v1.3.8-windows.zip")
